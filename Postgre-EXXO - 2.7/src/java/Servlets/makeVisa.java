...
public class makeVisa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        yes = false;
        String sql = "SELECT isBlogPermitted(dopusk_type, dopusk," + gid + ") FROM files WHERE id=" + id;
        ...
        if (yes && id != null && vid != null) {
            ...
            sql = "SELECT add_visa(" + id + "," + vid + "," + user + ",1)";
