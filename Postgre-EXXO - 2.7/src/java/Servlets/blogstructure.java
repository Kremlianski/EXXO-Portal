...
public class blogstructure extends HttpServlet {
...
//             Vector comp = new <Vector> Vector();
        ...
        try {
            ...
            String sql = "SELECT id, name, superior FROM blog_cat WHERE user_id='" + owner + "' ORDER BY name DESC";
...
//     Stack<Vector> st = new Stack<Vector>();
            ...
            marker = "0";
            count = 1;
            String title = "<div class=\"item cat r\" id=\"0\">";
            String titleEnd = "</div>";
                    ...
                    while (!st1.empty()) {
                        ...
                        if (v.get(3) != null) {
                            if (v.get(3).equals(marker)) {
                                ...
                                String title = "<div class=\"" + v.get(2) + " item\" id=\"" + v.get(0) + "\">";
                                String titleEnd = "</div>";
