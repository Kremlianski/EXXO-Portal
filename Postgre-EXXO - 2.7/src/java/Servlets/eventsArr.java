...
public class eventsArr extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql1 = "select hours, minutes, long from events where user_id='" + user + "' and day='" + date + "' AND id<>'" + id + "' ORDER BY hours, minutes";
