...
public class add_newBlog extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT bloges.id, bloges.text, bloges.time, bloges.owner, employee.fio, bus, name, "
                    ...
                    + "AS permitted, dopusk_type, is_blog_opend(bloges.global_id, " + user + ") AS opend, properTime(bloges.time) "
                    + "AS create FROM bloges, employee WHERE employee.id=bloges.owner AND NOT bloges.blocked " + string + "  "
                    + "AND(isBlogPermitted (dopusk_type, dopusk, " + guser + "::Int) OR owner=" + user + ")  ORDER BY time DESC LIMIT " + limit + " "
                    + "OFFSET " + start;
