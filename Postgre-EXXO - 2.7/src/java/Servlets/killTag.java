...
public class killTag extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (yes) {
            try {
                ...
                String sql1 = "SELECT tag_id FROM tags WHERE superior='" + id + "'";
                ResultSet rs1 = stmt.executeQuery(sql1);
                if (!rs1.next()) {
                    String sql = "delete from tags where tag_id='" + id + "'";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            try {
                ...
                Logger.getLogger(killTag.class.getName()).log(Level.SEVERE, null, ex);
            }
