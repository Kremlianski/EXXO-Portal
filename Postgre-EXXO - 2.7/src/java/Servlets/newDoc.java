...
public class newDoc extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String list = "<div  id='docsH3'><a href='newDoc.jsp'>Новые документы</a></div>";
        int block = 4;
        ...
        try {
            ...
            list = "<div  id='docsH3'><a href='" + href + "'>Документы " + add + "</a></div>";
            ...
            list += "<div class=\"newDocsContent " + small + "\"><ul>";
            int i = 1;
            while (rs.next()) {
                if (i == 1) {
                ...
                if (!href.contains("newDocK.jsp")) {
                    docOwner = "<td class='fio'><div style=\"background-image:url(IMG?id=" + rs.getInt(2) + ")\" title='" + Fio + "'></div></td>";
                }
