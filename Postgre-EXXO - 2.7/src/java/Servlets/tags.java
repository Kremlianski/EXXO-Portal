...
//             Vector comp = new <Vector> Vector();
        ...
        try {
            ...
            String sql = "SELECT tag_id, name, tag, superior FROM tags ORDER BY name DESC";
...
//     Stack<Vector> st = new Stack<Vector>();
            ...
            String titleEnd = "</div>";
            out.print(title + "Структура тегов" + titleEnd);
////////////
            class recurs {
                    ...
                    while (!st1.empty()) {
                        ...
                        if (v.get(3) != null) {
                            if (v.get(3).equals(marker)) {
                                ...
                                // if(v.get(2).equals("fil")) center+=" <span class=\"filepath\">("+v.get(5)+")</span>";
